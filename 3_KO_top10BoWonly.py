...
#other_features_train = np.column_stack((b,c,d))   # change this variable to test individual variables
       
c_train_data_featurescopy = c_train_data_features.copy()

#c_train_data_features_all = np.hstack((other_features_train,c_train_data_featurescopy))
c_train_data_features_all = c_train_data_featurescopy
...
ti_train_data_features_all = ti_train_data_featurescopy
...
c_test_data_features_all = c_test_data_featurescopy
ti_test_data_features_all = ti_test_data_featurescopy
