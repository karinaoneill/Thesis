...
other_features_train = np.column_stack((c,d))   # change this variable to test individual variables
...
other_features_test = np.column_stack((g,h))   # change this variable to test individual variables
